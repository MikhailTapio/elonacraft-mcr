...
package com.plr.elonacraft.entity;
...
import com.plr.elonacraft.entity.renderer.PutitRenderer;
import com.plr.elonacraft.ElonacraftModElements;

@ElonacraftModElements.ModElement.Tag
public class PutitEntity extends ElonacraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.5f)).build("putit").setRegistryName("putit");
	public PutitEntity(ElonacraftModElements instance) {
		super(instance, 12);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PutitRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ElonaCraftItemGroup.tab)).setRegistryName("putit_spawn_egg"));
	}
	...
	public static class CustomEntity extends SlimeEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new LookAtGoal(this, PlayerEntity.class, (float) 12));
